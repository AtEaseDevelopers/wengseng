    ...
    <body>
                ...
                <td style="width: 30%; vertical-align: text-top;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <span style="font-size: 14px;">{{ $order->delivering_date }}</span><br>
                            </td>
                        </tr>
                        @if ($type == 'order')
                            <tr>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; margin: 10px 0 0 0;">
            <tr>
                ...
                <td
                    ...
                    WEIGHT</td>
                <td
                    style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; font-weight: 700; width: 10%; text-align: center;">
                    U. PRICE</td>
                <td
                    style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; font-weight: 700; width: 10%; text-align: center;">
                    SUB TOTAL</td>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; margin: 50px 0 0 0;">
            <tr>
                ...
                <td
                    style="font-size: 14px; border-top: solid 1px black; font-weight: 700; text-align: right; padding: 5px 0 5px 0;">
                    SUB TOTAL : {{ number_format($sub_total, 2) }}</td>
            </tr>
            <tr>
                ...
                <td
                    style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; font-weight: 700; text-align: right; padding: 5px 0 5px 0;">
                    TOTAL AMOUNT : {{ number_format($total, 2) }}</td>
            </tr>
            <tr>
