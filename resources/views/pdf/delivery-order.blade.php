        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: center; width: 60%;">
                    <span style="font-size: 22px; font-weight: 700;">{{ env('APP_NAME') }}</span><br>501, Lot 151536,<br />
            ...
            <tr>
                <td style="width: 30%;">
                    <span style="font-size: 14px; font-weight: 700;">A/C NO : <span
                            style="font-weight: 100;">{{ $order->customer->sql_customer_code ?? '-' }}</span></span><br>
                </td>
                <td style="width: 70%;">
                    <span style="font-size: 14px; font-weight: 700;">TEL : <span
                            style="font-weight: 100;">{{ $order->customer->attn_contact }}</span></span><br>
                </td>
            </tr>
            <tr>
                <td style="width: 30%;">
                ...
                <td style="width: 70%;">
                    <span style="font-size: 14px; font-weight: 700;">FAX : <span
                            style="font-weight: 100;">{{ $order->customer->fax_no }}</span></span><br>
                </td>
            </tr>
        </table>
        <!-- Items -->
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; margin: 50px 0 0 0;">
            ...
            <tr>
                ...
                <td
                    ...
                    Total Weight : {{ $total_weight }} KG</td>
            </tr>
            <tr>
                <td colspan="3">
                    <span style="font-size: 12px;">Remark : Please return a carbon copy to Ayam Hebat Prosesan Sdn.
                        Bhd.</span>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; margin: 30px 0 0 0;">
            <tr style="margin: 0 0 50px 0;">
                ...
                <td style="padding: 0 0 100px 0;">
                    <span style="font-size: 14px;">I/We hereby confirmed and received to the above mentioned goods in a good
                        order & condition.</span>
                </td>
            </tr>
            <tr>
                <td style="font-size: 14px; text-align: center; border-top: solid 1px black; padding: 5px 0 0 0;">Authorised
                    Signature</td>
                <td style="width: 10%;"></td>
                <td style="font-size: 14px; text-align: center; border-top: solid 1px black; padding: 5px 0 0 0;">Customer
                    Company Stamp & Signature</td>
            </tr>
        </table>
    </body>
