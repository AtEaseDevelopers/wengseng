        ...
        <div class="col-md-12">
            <div class="card shadow no-border">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('admin.customer-categories.update', encrypt($category->id)) }}" method="POST" class="form-wrapper">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('admin.customer-categories.index') }}" class="btn btn-outline-secondary me-1">Back</a>
