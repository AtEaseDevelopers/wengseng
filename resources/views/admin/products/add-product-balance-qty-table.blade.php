            ...
            <div class="card shadow no-border mb-0">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="mb-0">Set Balance Quantity</h5>
                        <button type="button" class="btn btn-warning" id="add-line-btn">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Line
                        </button>
                    </div>
                    <form method="POST" action="{{ url('/admin/product-balance-qty/add') . '/' . $setup_date }}" enctype="multipart/form-data" class="form-wrapper" id="balance-qty-form">
                        @csrf
