...
@section('content')
    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <div class="card shadow no-border mb-0">
                <div class="card-body">
                    <h5 class="mb-4">Set Receive Quantity</h5>
                    <form method="POST" action="{{ url('/admin/product-receive-qty/add') . '/' . $setup_date }}" enctype="multipart/form-data" class="form-wrapper">
                        @csrf
                        @if ($products->count() == 0)
        ...
        $(document).ready(function(){
            ...
            $("#duplicate-btn").click(function(){
                ...
                if(duplicate_to_date == "{{ $setup_date }}"){
                    ...
                    Swal.fire({
                        title: 'Confirm',
                        text: 'Are you sure you want to duplicate this receive quantity setting to '+ duplicate_to_date +'?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = "{{ url('/admin/product-receive-qty/add/'.$setup_date) }}/" + duplicate_to_date;
                        }
                    });
                }
