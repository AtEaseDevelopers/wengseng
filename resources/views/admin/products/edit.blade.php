                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.products.update', encrypt($product->id)) }}" enctype="multipart/form-data" class="form-wrapper">
                        ...
                        @if ($product->image_url)
                            <div class="card shadow border-0 mb-4" style="width: 160px;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <span class="text-danger"> * <small>Uploading new will replace old one</small></span>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="col-md-12 d-flex gap-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sell_in" id="sell_in_qty" value="qty" {{ $product->sell_in == 'qty' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="sell_in_qty">
                                                Quantity
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sell_in" id="sell_in_weight" value="weight" {{ $product->sell_in == 'weight' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex gap-4">
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="show_weight" name="show_weight" {{ $product->show_weight == true ? 'checked' : '' }}>
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="show_qty" name="show_qty" type="checkbox" {{ $product->show_qty == true ? 'checked' : '' }}>
                                            ...
                                            <tbody>
                                                @foreach ($categories as $key => $category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01" class="form-control category-prices w-25" name="category_prices[{{ $category->id }}]" value="{{ $product_prices[$category->id] ?? 0 }}">
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
