                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="1" min="0" class="form-control @error('quotation_summary_sequence') is-invalid @enderror" name="quotation_summary_sequence" id="quotation_summary_sequence" placeholder="Enter quotation summary sequence" value="{{ old('quotation_summary_sequence') }}">
