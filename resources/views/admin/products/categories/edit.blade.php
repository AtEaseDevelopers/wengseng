                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="1" min="0" class="form-control @error('excel_sheet_batch') is-invalid @enderror" name="excel_sheet_batch" id="excel_sheet_batch" placeholder="Enter excel sheet batch number" value="{{ $category->excel_sheet_batch }}">
