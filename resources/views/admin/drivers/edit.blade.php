                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('lorry_number') is-invalid @enderror" name="lorry_number" id="lorry_number" placeholder="Enter driver lorry number" value="{{ $driver->lorry_number }}">
                                    @error('lorry_number')
